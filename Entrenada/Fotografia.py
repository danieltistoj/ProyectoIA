...
def ProcesarFoto(img):
	...
	##### FILTROS: Foto normal -> Filtro escala de grises -> Filtro Gaussiano #####
	foto = cv2.imread(img)
	...
	##### OBTENCION DE BINARIOS -> Foto blanco y negro (Literal)  #####
	...
	##### OBTENCIÓN DE BORDES DE LA FOTOGRAFÍA BINARIA #####
	canny = cv2.Canny(binario, 10, 100)
	#cv2.imshow('Bordes', canny)

	##### OBTENCIÓN DE LOS CORTNOROS DE LA FOTOGRAFÍA A TRAVES DE LOS BORDES #####
